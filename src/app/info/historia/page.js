...
export default function historia() {
  return (
    <main className="box-border w-full h-full m-w-[2500px]">
      <div className="flex flex-col items-center gap-6 w-full h-full lg:pb-12 pb-0">
        <div className="w-full overflow-hidden lg:h-[400px]">
          <VideoHistoria />
        </div>
        <div className="flex flex-col w-[95%] lg:py-12 py-0">
            <h2
              className={`text-center font-bold md:text-6xl text-4xl w-full sombrita ${bebas_neue.className}`}
            >
              Érase una vez Aquasella...
            </h2>
            <div className={`flex flex-col gap-6 md:gap-0 lg:py-12 py-6 h-fit w-full items-center box-border ${roboto.className}`}>
              <div className="flex flex-col gap-5 w-[95%] lg:w-[60%] h-full px-4 pb-10">
                <p className="lg:text-left text-center text-xl w-full">
              ...
              <div className="box-border px-12 lg:w-[75%] w-full sm:block hidden h-fit">
                <SliderThree object={YearsArray}/>
              </div>
              <div className="w-[75%] sm:hidden">
                <SliderOne object={YearsArray}/>
              </div>
            </div>
        </div>
      </div>
