          ...
          <div className="flex flex-col items-center gap-4 w-[1200px] max-w-[85%]">
            ...
            <div className="flex flex-col gap-8">
              <p className="text-left text-xl w-full px-6">
                AZURASA 21, SL (en adelante, la Compañía), manifiesta su respeto
                y cumplimiento de las disposiciones recogidas en la Ley Orgánica
                15/1999, de 13 de Diciembre, de Protección de Datos de Carácter
                Personal. Por ello, le informa de su política de protección de
              ...
              <p className="text-left text-xl w-full px-6">
                ...
                electrónica, el Usuario expresamente acepta y autoriza que
                dichos medios sean utilizados preferentemente como canal de
                comunicación, como canal para cumplir todas o alguna de las
                finalidades anteriormente informadas así como canal a través del
                cual poderle informar de cualesquiera otros cambios relevantes
                que se produzcan en el Portal.
              </p>
              <p className="text-left text-xl w-full px-6">
                Salvo en los campos en que expresamente se determine lo
                contrario, las respuestas a las preguntas sobre datos personales
                son voluntarias, sin que la falta de contestación a dichas
                preguntas implique una merma en la calidad de los servicios que
              ...
              <p className="text-left text-xl w-full px-6">
                ...
                con el usuario, la Compañía le informa de la utilización en el
                Portal de otros mecanismos informáticos relacionados con los
                datos personales, como son cookies y logs. A tal efecto, les
              ...
              <p className="text-left text-xl w-full px-6 flex flex-col">
                ...
                <p>
                  ...
                  usuarios y así realizar la medición y análisis estadístico de
                  la utilización que hacen los usuarios del servicio. Para ello
